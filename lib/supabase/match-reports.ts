...
export const GAME_SCHEDULE: ScheduleEntry[] = [
  ...
  { no: 9, type: 'double', round: 'Doppel-Runde' },
  { no: 10, type: 'double', round: 'Doppel-Runde' },
  { no: 11, type: 'single', homeSlot: 1, guestSlot: 3, round: '3. Einzel-Runde' },
  { no: 12, type: 'single', homeSlot: 2, guestSlot: 4, round: '3. Einzel-Runde' },
  { no: 13, type: 'single', homeSlot: 3, guestSlot: 1, round: '3. Einzel-Runde' },
  { no: 14, type: 'single', homeSlot: 4, guestSlot: 2, round: '3. Einzel-Runde' },
  { no: 15, type: 'single', homeSlot: 1, guestSlot: 4, round: '4. Einzel-Runde' },
  { no: 16, type: 'single', homeSlot: 2, guestSlot: 3, round: '4. Einzel-Runde' },
  { no: 17, type: 'single', homeSlot: 3, guestSlot: 2, round: '4. Einzel-Runde' },
  { no: 18, type: 'single', homeSlot: 4, guestSlot: 1, round: '4. Einzel-Runde' },
];
