...
/**
 * Startseiten-Inhalt, wiederverwendbar mit zwei Hero-Varianten:
 *  - 'classic'   → klassischer Hero + weiße Desktop-Navbar (die LIVE-Startseite).
 *  - 'fullbleed' → alternative Design-Vorschau: Full-bleed-Bild + Floating-Navbar.
