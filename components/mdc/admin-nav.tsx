...
// ============================================================
//
// Die Verwaltung hat inzwischen sieben Seiten. Ohne diese Leiste käme man von
...
import { CalendarDays, Camera, KeyRound, LayoutGrid, MapPin, Megaphone, Newspaper } from 'lucide-react';
...
const SEITEN = [
  ...
  { key: 'spielorte', href: mdcPath('/admin/spielorte'), label: 'Spielorte', icon: MapPin },
